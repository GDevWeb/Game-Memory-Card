...
const deckCards = [
    {
        name: "apple",
        src: "./ressources/apple.svg"
    },
    {
        name: "banana",
        src: "./ressources/banana.svg"
    },
    {
        name: "brocoli",
        src: "./ressources/brocoli.svg"
    },
    {
        name: "cherry",
        src: "./ressources/cherry.svg"
    },
    {
        name: "pepper",
        src: "./ressources/pepper.svg"
    },
    {
        name: "straw",
        src: "./ressources/straw.svg"
    },
];
...
let cardOne = null; //création de la variable pour stocker la première card sélectionnée 
let cardTwo = null; //création de la variable pour stocker la seconde card sélectionnée
let isPair = []; //création d"un tableau qui va stocker le choix des pairs de cards
