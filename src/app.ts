...
let cardOne: string; //création de la variable pour stocker la première card sélectionnée
let cardTwo: string; //création de la variable pour stocker la seconde card sélectionnée
